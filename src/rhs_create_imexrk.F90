module rhs_create_imexrk
   ...
   public :: allocate_rhs_imexrk, deallocate_rhs_imexrk, rhs_construct_temp_a, rhs_construct_vort_a, &
             & rhs_construct_uphibar_a, rhs_construct_uphibar_d, & 
             & rhs_construct_temp_d, rhs_construct_vort_d, rhs_construct_buo    

contains

   subroutine allocate_rhs_imexrk(Nm_max,Nr_max)
   ...
   end subroutine allocate_rhs_imexrk

   subroutine deallocate_rhs_imexrk
   ...
   end subroutine deallocate_rhs_imexrk
   ...
   subroutine rhs_construct_temp_a(Nm_max,Nr_max,uphi_temp_FR,ur_temp_FR,temprhs,Nm,rhs, &
      ...
      complex(kind=dp), intent(in) :: temprhs(Nm_max+1,Nr_max)
      ...
      if (time_scheme_type=='IMEXRK') then
         do i=1,Nr_max
            ...
            temp_real_rad(i)=temprhs(Nm+1,i)
            rhs(i)=0.0_dp
         end do
   ...
   subroutine rhs_construct_temp_d(Nm_max,Nr_max,uphi_temp_FR,ur_temp_FR,temprhs,Nm,rhs, &
                                 & time_scheme_type,Pr)
      ...
      if (time_scheme_type=='IMEXRK') then
         ...
         call chebtransform(Nr_max,ur_temp_rad,ur_temp_rad_spec) ! can be avoided Mar20 2018, likewise in others
         
         call chebtransform(Nr_max,temp_real_rad,temp_spec_rad)
                        
         call chebinvtranD1D2(Nr_max,temp_spec_rad,real_d_temp_rad,real_d2_temp_rad)
         
         call chebinvtranD1(Nr_max,ur_temp_rad_spec,real_d_ur_temp_rad(Nm+1,:)) ! can be avoided Mar20 2018, likewise in others
   ...
   subroutine rhs_construct_vort_a(Nm_max,Nr_max,uphi_omg_FR,ur_omg_FR,omg2,Nm,rhs1,rhsf, &
      ...
      if (time_scheme_type=='IMEXRK') then
         ...
         do i=1,Nr_max
            rhs2(i)= - (ii*real(Nm,kind=dp)*r_radius(i)*uphi_omg_rad(i)+real_d_ur_omg_rad(Nm+1,i) &
   ...
   subroutine rhs_construct_vort_d(Nm_max,Nr_max,uphi_omg_FR,ur_omg_FR,omg2,Nm,rhs1,rhsf, &
                                    & time_scheme_type,rhs2) 
   ...
   subroutine rhs_construct_buo(Nm_max,Nr_max,Ra,Pr,uphi_omg_FR,ur_omg_FR,omg2,Nm,rhs1,rhsf, &
      ...
      if (time_scheme_type=='IMEXRK') then
         ...
         do i=1,Nr_max
            rhs2(i)= - (Ra/Pr)*(ii*real(Nm,kind=dp)*(r_radius(i))*temprhs(Nm+1,i))
                    ! buoyancy term
